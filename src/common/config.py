...
# NOTE: there is deliberately NO listing-verify on/off toggle. kimi runs as step ②
# of the daily pipeline whenever it's available (binary + KIMI_API_KEY present); if
# it can't run, the pipeline reports a warning (Feishu) — a missing capability should
# ALERT, not be silently switched off. A redundant toggle was removed 2026-06.
