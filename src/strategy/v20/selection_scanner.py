# === MODULE PURPOSE ===
# V20-owned frozen copy of the V16 board-first funnel + LGBRank scoring.
#
# This module intentionally does not import the production V16 scanner. Keep
# V20 changes here so they cannot change V16 production behavior.
...
from src.strategy.v20.selection_scorer import CandidateSnapshot, LGBRankScorer, ScoredStock
